...
class IncomingCallActivity : AppCompatActivity() {
    ...
    private lateinit var fullscreenContent: androidx.constraintlayout.widget.ConstraintLayout
    private lateinit var fullscreenContentControls: androidx.constraintlayout.widget.ConstraintLayout
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mFragmentTransaction1.replace(binding.fullscreenContent.id, mFragment1).commit()
